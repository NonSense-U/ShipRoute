...
class CreateShipmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'route.pickup_lat' => ['required', 'string', 'max:50'],
            'route.pickup_lon' => ['required', 'string', 'max:50'],
            'route.pickup_checkpoint_details' => ['required', 'array'],
            'route.pickup_checkpoint_details.supervisor_name' => ['required', 'string', 'max:255'],
            'route.pickup_checkpoint_details.supervisor_phone_number' => ['required', 'string', 'max:20'],
            'route.pickup_checkpoint_details.address' => ['nullable', 'string', 'max:255'],
            'route.pickup_checkpoint_details.street' => ['nullable', 'string', 'max:255'],
            'route.pickup_checkpoint_details.building_number' => ['nullable', 'string', 'max:50'], 
            'route.pickup_checkpoint_details.notes' => ['nullable', 'string', 'max:255'],
